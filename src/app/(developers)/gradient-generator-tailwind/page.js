        ...
        <SingleStructures
            ...
            desc={
                <>
                    ...
                    با <strong>ابزار تولید گرادیانت Tailwind</strong>، می‌توانید رنگ‌ها، جهت و نوع گرادیانت (خطی یا شعاعی) را به‌دلخواه تنظیم کنید و پیش‌نمایش زنده آن را ببینید. پس از ساخت گرادیانت، کد Tailwind CSS آماده کپی و استفاده در پروژه‌های شما ارائه می‌شود.
                    <strong>چرا ابزار گرادیانت dtools؟</strong> این ابزار با رابط کاربری ساده، پشتیبانی از تنظیمات پیشرفته و خروجی کد بهینه‌شده، کار طراحی شما را سریع‌تر می‌کند. چه در حال طراحی وب‌سایت یا اپلیکیشن باشید، dtools به شما کمک می‌کند تا ظاهری حرفه‌ای خلق کنید.
                    <strong>dtools</strong> مجموعه‌ای از ابزارهای کاربردی برای طراحان، برنامه‌نویسان و کاربران روزمره ارائه می‌دهد. همین حالا ابزار تولید گرادیانت دلخواه را امتحان کنید و کد Tailwind CSS خود را دریافت کنید!
                </>
            }>

            <GradientGeneratorTailwind/>
