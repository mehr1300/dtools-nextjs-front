    ...
    return (
        <div className="flex flex-col gap-5 justify-center w-full items-center">
            <div className="flex flex-col justify-center items-center relative gap-3">
                ...
                <input dir="ltr" id="data"  type="text" value={value} onChange={(e)=>setValue(e.target.value)} className="flex flex-row justify-center items-center w-80 border border-gray-200 bg-white outline-sky-200 rounded-xl p-3 text-gray-700"/>
            </div>
