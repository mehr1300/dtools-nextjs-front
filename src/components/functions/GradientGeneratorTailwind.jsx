        ...
        <div className="max-w-screen-lg mx-auto">
            <div className="text-center mb-10">
                <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
                    تولید کننده گرادیانت Tailwind CSS v4
                </h1>
                <p className="mt-3 text-xl text-gray-500">
                    ایجاد گرادیانت‌های زیبا با رنگ‌های داخلی تیلویند
                </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    >
                        <div className="bg-white/80 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm">
                            <p className="text-gray-800 font-medium">گرادیانت شما</p>
                        </div>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    {/* Gradient Type */}
                    <div className="mb-6">
                        <label className="block text-sm font-medium text-gray-700 mb-2">نوع گرادیانت</label>
